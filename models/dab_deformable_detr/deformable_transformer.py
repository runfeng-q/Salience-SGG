...
class DeformableTransformer(nn.Module):
    ...
    def forward(self, srcs, masks, pos_embeds, query_embed=None):
        ...
        # decoder
        # import ipdb; ipdb.set_trace()
        hs, inter_references, outputs_class, outputs_coord = self.decoder(tgt, reference_points, memory,
        ...
        if self.two_stage:
            return hs, init_reference_out, inter_references_out, enc_outputs_class, enc_outputs_coord_unact, outputs_class, outputs_coord
        return hs, init_reference_out, inter_references_out, None, None, outputs_class, outputs_coord
...
class DeformableTransformerDecoder(nn.Module):
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes,
        ...
        if self.return_intermediate:
            return torch.stack(intermediate), torch.stack(intermediate_reference_points), outputs_classes, outputs_coords

        return output, reference_points, outputs_classes, outputs_coords
